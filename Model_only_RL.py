...
def phaseIIModel(arg_resFile, arg_rSeed):
    ...
    for nt in range(n_trials):
        ...
        # if nt==0:                                         # to check divergence
        #     syllable_outputs[syll][...] = MC
        ...
        # if nt == n_trials - n_lesioned_trials:    BG_influence = 0    # To check Hebbian learning

        if nt == n_trials - n_cut_noise:
            BG_noise_std = 0.0
            RA_noise_std = 0.0
            MC_noise_std = 0.0
            eta = 0
    ...
    ax.set_title("Testing normalised sigmoid")
