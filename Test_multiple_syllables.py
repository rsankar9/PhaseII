...
def phaseIIModel(arg_resFile, arg_rSeed):
    ...
    BG_max = RA_max = MC_max = 1            # sigmoidal limits and slope
    MC_sig_slope = BG_sig_slope = 5
    arg_steepFactor = 1
    RA_sig_slope = MC_sig_slope * arg_steepFactor
    ...
    results["Output range"] = str([output_range, min_possible_output, max_possible_output])
    ...
    for syll in syllables:
        ...
        ax.set_title("Testing multiple syllables")
        ...
        plt.tight_layout()
        plt.savefig(resFile + "_" + syll + ".pdf")
        # plt.show()
    ...
    Data = {
        "Purpose": "Learning Syllable A and B",
        # "GitHash": "",
        "Random seed": rSeed,
